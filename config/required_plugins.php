...
function required_plugins() {
    ...
    $config = array(
        ...
        'strings'      	=> array(
            ...
            'notice_can_install_required'       => _n_noop( 'Gramophone requires the following plugin: %1$s.', 'Gramophone requires the following plugins: %1$s.', $theme_text_domain ),
            'notice_can_install_recommended'    => _n_noop( 'Gramophone recommends the following plugin: %1$s.', 'Gramophone recommends the following plugins: %1$s.', $theme_text_domain ),
